    ...
    function init() {
        ...
        picker.innerHTML =
            ...
            '<div id="clr-swatches" class="clr-swatches"></div>' + ("<button type=\"button\" id=\"clr-clear\" class=\"clr-clear\">" +
                settings.clearLabel + "</button>") +
            ('') +
            ("<button type=\"button\" id=\"clr-color-preview\" class=\"clr-preview\" aria-label=\"" +
                settings.a11y.close + "\"><img src=\"images/editor-icon/color-picker-cursor.svg\" class=\"clr-picker-icon\" ></button>")
            + ("<span id=\"clr-open-label\" hidden>" +
